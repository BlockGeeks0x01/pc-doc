define({ "api": [
  {
    ...
    "group": "/Users/sgy/project/purchasing-consortia/purchasing_consortia/frontend/product.py",
    "groupTitle": "/Users/sgy/project/purchasing-consortia/purchasing_consortia/frontend/product.py",
    "name": ""
  },
  {
    "type": "get",
        ...
        "Parameter": [
          {
            ...
            "field": "ignore_risk",
            "defaultValue": "0",
            "description": "<p>是否忽略风险,0:否，1：是</p>"
          },
          {
            "group": "Parameter",
            "type": "int",
            ...
            "field": "profit_type",
            "defaultValue": "2",
            "description": "<p>1:全部，2:固定,3:浮动,4:单一股权</p>"
          },
          {
            "group": "Parameter",
            "type": "int",
            ...
            "field": "exclude_child",
            "defaultValue": "0",
            "description": "<p>0:不排除子客户，1：排除子客户</p>"
          },
          {
            "group": "Parameter",
            "type": "int",
            ...
            "field": "currency",
            "defaultValue": "2",
            "description": "<p>1:全部，2：人民币,3:美元</p>"
          },
          {
            "group": "Parameter",
            "type": "date",
  ...
  {
    "type": "patch",
    "url": "/api/customers/:id/risk",
    "title": "修改客户风险计入",
    "name": "EditCustomerRisk",
    "group": "Customer",
    "parameter": {
      "fields": {
        "Parameter": [
  ...
  {
    "type": "patch",
    "url": "/api/orders/{订单号}/ignore_risk",
    "title": "修改订单风险计入",
    "name": "OrderProfitRisk",
    "group": "Order",
    "parameter": {
      "fields": {
        "Parameter": [
